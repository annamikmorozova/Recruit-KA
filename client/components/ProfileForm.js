    ...
    render() {
        return (
            <form className="profile-form">
                ...
                <div>Choose a gender you would like to compete with</div>
                <div className="col-md-12">
                ...
                <div>Note: if you have more than one citizenship, choose one you represent while competing the sport</div>
                <div className="col-md-12">
